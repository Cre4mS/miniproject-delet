(function(n) {
    ...
    jQuery.fn.mbComingsoon = function(i) {
        ...
        return this.each(function() {
            ...
            if (e)
                i == "start" ? e.start() : i == "stop" ? e.stop() : n.isPlainObject(i) && (i.expiryDate instanceof Date && (e.end = i.expiryDate),
                ...
                if (i instanceof Date ? r.expiryDate = i : n.isPlainObject(i) ? n.extend(r, u, i) : typeof i == "string" && (r.expiryDate = new Date(i)),
                !r.expiryDate)
